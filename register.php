...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6 border border-info border-3">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group">
                    <label for="Password" class="form-label"></label>
                    <input type="password" name="confirm_password" id="confirm_password" placeholder="confirm password" class="form-control <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>">
                ...
                <br>
                <p>Already have an account? <a class="btn btn-primary" href="login.php" role="button">Login Here</a></p>
            </form>
            </div> 
